...
class SerializableMessage:
    def get_message(self, coin="pinkcoin"):
...
class MessageHeader:
    ...
    def __init__(self, coin="pinkcoin"):
...
#     field = fields.VariableStringField()
...
#     version =  fields.Int32LEField()
#     relay_until = fields.Int64LEField() # when newer nodes stop relaying to newer nodes
#     expiration = fields.Int64LEField()
#     id = fields.Int32LEField()
#     cancel = fields.Int32LEField()
#     len_set_cancel = fields.VariableIntegerField()
#     set_cancel = fields.ListField(CancelAlertSerializer)
#     min_ver = fields.Int32LEField() # lowest version inclusive
#     max_ver = fields.Int32LEField() # highest version inclusive
#     len_set_sub_ver = fields.VariableIntegerField() # empty matches all
#     set_sub_ver = fields.ListField(SubVerAlertSerializer)
#     priority = fields.Int32LEField()
#     comment = fields.VariableStringField()
#     status_bar = fields.VariableStringField()
#     reserved = fields.VariableStringField()
...
#     # id = fields.Int32LEField()
#     # cancel = fields.Int32LEField()
#     # set_cancel = fields.VariableIntegerField()
#     # set_cancel = fields.ListField(CancelAlertSerializer)
#     # min_ver = fields.Int32LEField() # lowest version inclusive
#     # max_ver = fields.Int32LEField() # highest version inclusive
#     # set_sub_ver = fields.VariableIntegerField() # empty matches all
#     # set_sub_ver = fields.ListField(SubVerAlertSerializer)
#     # priority = fields.Int32LEField()
#     # comment = fields.VariableStringField()
#     # status_bar = fields.VariableStringField()
...
#     # payload = fields.NestedField(AlertPayloadSerializer)
#     alert_info = fields.NestedField(AlertPayloadSerializer)
#     # payload = fields.VariableStringField()
#     signature = fields.VariableStringField()
