...
class NetworkBasicClient:
    """The base class for a network client, this class
    implements utility functions to create your own class.

    :param socket: a socket that supports the makefile() method.
    """
    ...
    def loop(self):
        ...
        while True:
            ...
            if handle_func and callable(handle_func):
                handle_func(message_header, message) # pylint: disable=E1102

class NetworkClient(NetworkBasicClient):
    ...
    def handshake(self):
        """This method will implement the handshake of a
        network protocol. It will send the Version message."""
        version = Version()
